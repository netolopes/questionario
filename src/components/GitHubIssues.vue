<template>
    <div class="container">
            ...
            <div class="col">
                <div class="form-group">
                    <input v-model="username"
                           type="text" class="form-control"  placeholder="github username:vuejs">
                </div>
            </div>
            ...
            <div class="col">
                <div class="form-group">
                    <input v-model="repository"
                           type="text" class="form-control" placeholder="github repositório:vue">
                </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    <button @click.prevent.stop="reset()"
                            class="btn btn-danger">LIMPAR</button>
                             <button @click.prevent.stop="proximo()"
                            class="btn btn-primary">PRÓXIMO</button>
                              <button @click.prevent.stop="voltar()"
        ...
        <table  ref="listagem" v-show="mostrarTabela" class="table table-sm table-bordered">
            <thead>
            <tr>
